...
2. Clone the repo to local:
   ...
   ```bash
   git clone https://github.com/rockz5555/MagiskOnWSALocal.git --depth 1
   ```

   v2
   ```bash
   git clone https://github.com/rockz5555/MagiskOnWSALocal.git && cd MagiskOnWSALocal && git checkout build-fix
   ```

4. Run `cd MagiskOnWSALocal`.
